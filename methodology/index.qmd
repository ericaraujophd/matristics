...
Everything needed to repeat or extend the evaluation is published: the [question bank](../figures/index.qmd) as CSV, the rubric and scoring sheet above, the [collection pipeline](../data-collection/index.qmd), and the reference profiles condensed onto the figure pages ([Macrina](../figures/macrina.qmd), [Olympias](../figures/olympias.qmd)). Three parts of the design will need adaptation rather than reuse.
