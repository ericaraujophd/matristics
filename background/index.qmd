...
1. **A domain-specific benchmark** for early church history with an explicit gender-bias focus, comparing multiple frontier models on the same 42-question bank across 14 female figures.
