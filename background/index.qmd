...
2. **A replicable methodology** — rubric, annotation protocol, reference profiles, and agreement metrics — designed so that other researchers can apply the same design to other underdocumented historical populations.
