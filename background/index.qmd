...
1. **Establish a replicable evaluation methodology** for assessing LLM outputs on specialized historical content — rubric, annotation protocol, and question bank — designed to transfer to other underdocumented historical populations.
...
3. **Build a public benchmark** comparing model performance across figures, rubric dimensions, and question difficulty, released openly so that it can be rerun as models evolve.
