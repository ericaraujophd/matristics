...
**Matristics** — from *mater*, by analogy with *patristics* — asks how well large language models know the women who shaped Christianity's first five centuries. We evaluate Claude, ChatGPT, Gemini, and Grok not only for factual accuracy, but for whether they reproduce the androcentric silences of the historical record itself. Read more in the [Project Overview](background/project-overview.qmd).
...
<span class="ql-desc">14 female figures and the 42 questions used to probe LLM knowledge.</span>
</a>
...
<span class="ql-desc">Model comparison by figure, dimension, and difficulty.</span>
</a>
...
> Araujo, Eric; Rylaarsdam, D. *Matristics: LLM Evaluation in Early Church History*. 2026.
