...
The Gender Bias dimension of the rubric ({doc}`../methodology/rubric`) is the primary instrument for detecting androcentric bias. The annotation protocol also includes **paired question design**: for each female figure, a parallel question is asked about a male contemporary of equal or lesser historical significance, allowing systematic comparison of response depth and completeness.
